...
const Navbar = () => {
  ...
  const handleNavClick = (item) => {
    setActiveNavItem(item.toLowerCase().replace(/\s+/g, ""));
    toggleMenu();
  };
  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto flex items-center justify-around">
        {/* LEFT: Logo */}
        <div className="hidden md:flex items-center font-bold text-3xl hover:cursor-pointer hover:scale-105 transition-all duration-300">
        ...
        <div className="flex md:hidden items-center font-bold text-3xl hover:cursor-pointer hover:scale-105 transition-all duration-300">
          <img src="/nav-logo.png" alt="BotNexus Logo" width={60} height={50} />
          <span className="text-[#ff2121] mr-2">Bot</span>
          <span className="text-white hover:text-[#2196F3] duration-300">
            Nexus
            ...
            (item) => (
              <Link
                ...
                className={`text-md transition-all cursor-pointer duration-300 ${
                  activeNavItem === item.toLowerCase().replace(/\s+/g, "")
      ...
      {shouldRenderMenu && (
        <div
          className={`md:hidden fixed top-16 left-0 right-0 px-20 py-6 bg-[#0f0f1c]/95 
            backdrop-blur-lg shadow-2xl border-t border-red-500/70 
          ...
          <div className="flex flex-col space-y-6">
            {[
              ...
              <Link
                ...
                className={`text-sm font-semibold tracking-wide font-['Orbitron'] transition-colors duration-300 cursor-pointer ${
