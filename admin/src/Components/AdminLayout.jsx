...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { path: "/feedback", icon: <FaComment/>, label:"Feedbacks"},
    { path: "/achievements", icon: <FaTrophy />, label: "Achievements" },
    { path: "/projects", icon: <FaFolder />, label: "Projects" },
    {
      path: "/competitions",
      icon: <FaTrophy />,
      label: "Competitions",
    ...
    { path: "/blog", icon: <FaPenAlt />, label: "Blogs" },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-700">
            <motion.button
              ...
              className={`flex items-center justify-center w-full py-2 rounded-lg bg-red-600 hover:bg-red-700 transition-colors cursor-pointer ${
