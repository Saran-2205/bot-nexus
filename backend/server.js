...
const allowedOrigins = ['https://www.botnexus.in', 'https://bot-nexus-6qox.onrender.com', 'https://nexus-hq.onrender.com',"https://botnexus-nextjs.vercel.app"];

app.use(
  cors({
    origin: function (origin, callback) {

      // Allow server-side requests (Next.js server components)
      if (!origin) {
